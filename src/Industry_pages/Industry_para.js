const IndustryPara = [
    {
        paragraph1: "Arcgate helps companies leading innovation in the advertising industry with data categorization, tagging, reporting and improving ad-matching relevance",
        paragraph2: "Ad networks and monetization platforms help brands communicate key marketing messages across all screen formats and devices. They help publishers monetize their properties by delivering delightful ad experiences that blend seamlessly into the content in apps and websites.",


        paragraph3: "Ad networks help drive app downloads, increase brand engagement and maximize revenue through reach and relevance. It’s critical for ad networks to deliver the most relevant and contextual ads to consumers. Doing this requires constantly improving the ad matching algorithms through machine-learning. Our human experts provide training data that results in constant improvements in machine-learning algorithms.",
        ...
        paragraph10: "The new sharing economy has enabled people to rent anything that you can imagine directly from each other. Technology has reduced transaction costs, making sharing assets cheaper and easier than ever—and therefore possible on a much larger scale.",
