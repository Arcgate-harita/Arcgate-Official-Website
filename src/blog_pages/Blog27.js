                ...
                <section className='blog-section2'>
                    <div className='blog-content2'>
                        ...
                        {paragraphs.map((section, index) => (
                            <div key={index}>
                                <p>{section.paragraph3G}</p>
                                <p></p>
                                {section.bulletPoints12 && (
                                    <ul>
                                        {section.bulletPoints13.map((point, bulletIndex) => (
                                            <li key={bulletIndex}>{point}</li>
                                        ))}
                                    </ul>
                                )}
                                <p></p>
                                <p>{section.paragraph3H}</p>
                                <p></p>
                                <p>{section.paragraph3I}</p>
                                <p></p>
                                {section.bulletPoints13 && (
                                    <ul>
