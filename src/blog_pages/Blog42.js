                ...
                <section className='blog-section2'>
                    <div className='blog-content2'>
                        ...
                        {paragraphs.map((section, index) => (
                            <div key={index}>
                                <p>{section.paragraph7M}</p>
                                <p></p>
                                <img src={imagePaths.blogImage1} alt='' />
                                <p>{section.paragraph7N}</p>
                                <p></p>
                                <p>{section.paragraph7O}</p>
                                <p></p>
                                <p>{section.paragraph7P}</p>
                                <p></p>
                                <p>{section.paragraph7Q}</p>
                                <p></p>
