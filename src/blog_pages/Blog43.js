                ...
                <section className='blog-section2'>
                    <div className='blog-content2'>
                        ...
                        {paragraphs.map((section, index) => (
                            <div key={index}>
                                <p>{section.paragraph7R}</p>
                                <p></p>
                                <p>{section.paragraph7S}</p>
                                <p></p>
                                <p>{section.paragraph7T}</p>
                                <p></p>
                                <p>{section.paragraph7U}</p>
                                <p></p>
                                <p>{section.paragraph7V}</p>
                                <p></p>
                                <p>{section.paragraph7W}</p>
                                <p></p>
                                <p>{section.paragraph7X}</p>
                                <p></p>
                                <p>{section.paragraph7Y}</p>
                                <p></p>
                                <p>{section.paragraph7X}</p>
                                <p></p>
                                <p>{section.paragraph8A}</p>
                                <p></p>
                                <p>{section.paragraph8B}</p>
                                <p></p>
                            </div>
                        ))}
